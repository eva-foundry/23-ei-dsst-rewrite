...
# GitHub Copilot Instructions -- EI-DSST Rewrite

**Template Version**: 7.0.0 (Session 71 - project authority contract)  
**Last Updated**: 2026-03-15  
**Project**: EI-DSST Rewrite  
**Path**: C:\eva-foundry\23-ei-dsst-rewrite\
...
This file is the **project-level operating contract** for `23-ei-dsst-rewrite`.
...
Invoke-RestMethod "$($session.base)/model/projects/23-ei-dsst-rewrite"
```
...
**Status**: poc  
**Current Phase**: Phase 1 â Discovery  
