...
<!-- Placeholders: 23-ei-dsst-rewrite = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 23-ei-dsst-rewrite - Organization Standards
